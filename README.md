About r-mefa-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-mefa-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4233&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-mefa-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-mefa` can be installed with `conda`:
...
```
mamba install r-mefa
```

It is possible to list all of the versions of `r-mefa` available on your platform with `conda`:
...
```
mamba search r-mefa --channel conda-forge
```
...
mamba repoquery search r-mefa --channel conda-forge

# List packages depending on `r-mefa`:
mamba repoquery whoneeds r-mefa --channel conda-forge

# List dependencies of `r-mefa`:
mamba repoquery depends r-mefa --channel conda-forge
```
